...
REST (Representational State Transfer) — архитектурный стиль построения API, использующий HTTP-методы:
GET, POST, PUT, DELETE.
RESTful — это API, которое использует HTTP-методы для работы с ресурсами.
...
1. HTTP-анализ с использованием curl. Получение данных о рейсах с сайта aeroflot.ru 
2. Разработка REST API (ресторанное меню). "Ресторанное меню" (сущность: id, dish_name,price, category).
